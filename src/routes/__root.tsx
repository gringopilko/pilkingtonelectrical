...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  ...
  meta: [
    ...
    { property: "og:image", content: "https://www.pilkingtonelectrical.com.au/og-image.png" },
    ...
    { name: "twitter:image", content: "https://www.pilkingtonelectrical.com.au/og-image.png" },
  ],
  links: [
