...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  ...
  meta: [
    ...
    { property: "og:title", content: "Pilkington Electrical | Residential & Commercial Electrician Melbourne" },
    ...
    { name: "twitter:title", content: "Pilkington Electrical | Residential & Commercial Electrician Melbourne" },
