        ...
        children: JSON.stringify({
          ...
          itemListElement: [
            ...
            },
            {
              ...
              position: 2,
              name: "Contact",
              item: "https://pilkingtonelectrical.com.au/contact",
            },
          ],
        }),
      },
      ...
      <section className="mx-auto max-w-7xl px-6 py-16">
        <div className="grid gap-6 md:grid-cols-3">
          ...
          <ContactCard
            ...
            label="Location"
            value="Hampton East, VIC"
            href="https://www.google.com/maps/search/?api=1&query=Hampton+East+VIC+Australia"
        ...
        <div
          id="quote"
          className="mt-12 scroll-mt-24 rounded-xl border border-border bg-card p-8 md:p-12"
        >
          <h2 className="text-center text-xl font-bold tracking-tight">Request a Free Quote</h2>
          <p className="mx-auto mt-2 max-w-md text-center text-sm text-muted-foreground">
            Fill in the form and I'll get back to you promptly. If you'd like to include photos of
            the job, feel free to email directly:{" "}
            <a
              href="mailto:contact@pilkingtonelectrical.com.au"
