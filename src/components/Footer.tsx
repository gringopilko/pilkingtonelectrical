      ...
      <div className="mx-auto max-w-7xl px-6 py-16">
        <div className="grid gap-10 md:grid-cols-4">
          <div>
            ...
            <p className="mt-4 text-sm text-muted-foreground">
              Licensed electrician serving homes, body corporates and businesses across South East
              Melbourne.
            </p>
            <p className="mt-4 text-xs text-muted-foreground">
              REC 30450 &middot; ABN 16 937 824 485
            </p>
          </div>
          ...
          <div>
            ...
            <div className="mt-4 flex flex-col gap-2">
              ...
              <Link to="/suburbs" className="text-sm text-muted-foreground hover:text-foreground">
                Suburbs
              </Link>
              <Link to="/faqs" className="text-sm text-muted-foreground hover:text-foreground">
                FAQs
              </Link>
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-border pt-8 md:flex-row">
          <p className="text-center text-sm text-muted-foreground md:text-left">
            &copy; {new Date().getFullYear()} Pilkington Electrical. Licensed electrician. South
            East Melbourne.
          </p>
